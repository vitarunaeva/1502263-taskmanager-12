...
const renderBoard = (boardContainer, boardTasks) => {
  ...
  if (boardTasks.length > TASK_COUNT_PER_STEP) {
    ...
    render(boardComponent.getElement(), loadMoreButtonComponent.getElement(), RenderPosition);
...
render(siteHeaderElement, new SiteMenuView().getElement(), RenderPosition);
render(siteMainElement, new FilterView(filters).getElement(), RenderPosition);
